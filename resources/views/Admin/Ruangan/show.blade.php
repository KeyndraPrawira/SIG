              ...
              <div class="row">
                <div class="col">
                  ...
                  <form action="{{ route('ruangan.update', $ruangan->id) }}" class="form " method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" class="form-control" name="nama_ruangan" disabled value="{{ $ruangan->nama_ruangan }}">

                    <label for="" class="mt-2" >Kategori</label>
                    <select name="kategori_id" id="" class="form-select ">
                        @foreach ($kategori as $kat)
                            <option value="{{ $kat->id }}" disabled {{ $kat->id == $ruangan->kategori_id ? 'selected' : ''}} >{{ $kat->nama_kategori }}</option>
                        @endforeach
                    </select>
                    ...
                    <select name="lantai_id" id="" disabled class="form-select ">
                    ...
                    <textarea name="deskripsi" id="" class="form-control" disabled >{{ $ruangan->deskripsi }}</textarea>
                    ...
                    <br>
                    <a href="{{ route('ruangan.index') }}"class="btn btn-primary mt-2">Kembali</a>
                  </form>
                </div>
              </div>
            </div>
