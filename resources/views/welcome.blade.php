  ...
  <div class="navbar-wrapper">
    <div class="m-header flex items-center py-4 px-6 h-header-height">
      <a href="dashboard/index.html" class="b-brand flex items-center gap-3">
        ...
        <img src="Admin/images/logo-white.svg" class="img-fluid logo logo-lg" alt="logo" />
        <img src="Admin/images/favicon.svg" class="img-fluid logo logo-sm" alt="logo" />
      </a>
    </div>
        ...
        <div class="dropdown-body header-notification-scroll relative py-4 px-5"
          ...
          <div class="card mb-2">
            <div class="card-body">
              <div class="flex gap-4">
                <div class="shrink-0">
                  <img class="img-radius w-12 h-12 rounded-0" src="Admin/images/user/avatar-1.jpg" alt="Generic placeholder image" />
                </div>
                <div class="grow">
          ...
          <div class="card mb-2">
            <div class="card-body">
              <div class="flex gap-4">
                <div class="shrink-0">
                  <img class="img-radius w-12 h-12 rounded-0" src="Admin/images/user/avatar-2.jpg" alt="Generic placeholder image" />
                </div>
                <div class="grow">
          ...
          <div class="card mb-2">
            <div class="card-body">
              <div class="flex gap-4">
                <div class="shrink-0">
                  <img class="img-radius w-12 h-12 rounded-0" src="Admin/images/user/avatar-3.jpg" alt="Generic placeholder image" />
                </div>
                <div class="grow ms-3">
          ...
          <div class="card mb-2">
            <div class="card-body">
              <div class="flex gap-4">
                <div class="shrink-0">
                  <img class="img-radius w-12 h-12 rounded-0" src="Admin/images/user/avatar-4.jpg" alt="Generic placeholder image" />
                </div>
                <div class="grow ms-3">
          ...
          <div class="card mb-2">
            <div class="card-body">
              <div class="flex gap-4">
                <div class="shrink-0">
                  <img class="img-radius w-12 h-12 rounded-0" src="Admin/images/user/avatar-5.jpg" alt="Generic placeholder image" />
                </div>
                <div class="grow ms-3">
      ...
      <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown p-2 overflow-hidden">
        <div class="dropdown-header flex items-center justify-between py-4 px-5 bg-primary-500">
          <div class="flex mb-1 items-center">
            <div class="shrink-0">
              <img src="Admin/images/user/avatar-2.jpg" alt="user-image" class="w-10 rounded-full" />
            </div>
            <div class="grow ms-3">
                ...
                <div class="table-responsive">
                  <table class="table table-hover">
                    <tbody>
                      <tr class="unread">
                        <td>
                          <img class="rounded-full max-w-10" style="width: 40px" src="Admin/images/user/avatar-1.jpg" alt="activity-user" />
                        </td>
                        <td>
                      ...
                      <tr class="unread">
                        <td>
                          <img class="rounded-full max-w-10" style="width: 40px" src="Admin/images/user/avatar-2.jpg" alt="activity-user" />
                        </td>
                        <td>
                      ...
                      <tr class="unread">
                        <td>
                          <img class="rounded-full max-w-10" style="width: 40px" src="Admin/images/user/avatar-3.jpg" alt="activity-user" />
                        </td>
                        <td>
